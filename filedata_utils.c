...
static void	assign_usr_permissions(String buf, struct stat filestat)
{
	if (!buf)
		return ;
...
static void	assign_group_permissions(String buf, struct stat filestat)
{
	if (!buf)
		return ;
...
static void	assign_oth_permissions(String buf, struct stat filestat)
{
	if (!buf)
		return ;
